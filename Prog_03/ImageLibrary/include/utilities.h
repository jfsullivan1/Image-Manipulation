...
/** returns 0 if the two images provided have equal rasters, otherwise returns 1.
...
/** returns 1 if the path provided is an existing directory, 0 otherwise. 
 *  @param path		this is the path that will be checked. Will be used for output directory.
 */
